    ...
    <>
      <main>
        ...
        >
          ...
          <motion.div
            variants={fadeIn}
            className="hidden md:flex flex-col md:flex-row h-full md:!h-auto w-full md:!min-h-screen bg-gradient-to-b from-white/0 to-black/100 py-5 p-10 md:p-10 md:py-5 lg:p-20 lg:py-10 xl:p-20 xl:py-10 2xl:p-40 2xl:py-20 justify-center md:justify-between gap-5"
          >
            <motion.div className="leftText !h-auto w-full md:w-1/2" variants={fadeIn}>
              ...
              <p className="text-custom-whiteIce description">
                ...
                <span className="emphasis"> 5th in the United States </span> out of over 100 participating teams.
              </p>
            </motion.div>

            <motion.div className="justify-center md:justify-end my-auto w-full md:w-1/2 flex flex-row h-fit" variants={fadeIn}>
              <div className="mainContent-container rounded-s-md !h-fit">
                {management.map((profile) => (
                  <motion.li key={profile.name} className="flex flex-row gap-3 md:gap-5" variants={fadeIn}>
                    {profile.profileImg ? (
                      <Image
           ...
           <motion.div className="text-container md:!h-auto md:!min-h-screen" variants={fadeIn}>
             ...
             <div className='timeline-container w-fit md:w-1/2 '>
               {competitionTimeline.map((event, index) => (
                // <>
                  <motion.div className='timeline-event' key={index} variants={fadeIn}>
