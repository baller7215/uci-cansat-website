...
type AnyProjectForYearPage = any;
...
export type ProjectYearContentProps = {
  yearLabel?: string;
  /** Same shape as `yearTeamProject.*.project` (constants or server-mapped Sanity) */
  project: unknown;
};

const ProjectYearContent = ({ yearLabel, project: projectProp }: ProjectYearContentProps) => {
  if (!projectProp) {
    return (
      <main>
        <CoverPage
        ...
        <section className="section-container">
          <div className="text-container !flex-col !justify-center !items-center min-h-[40vh]">
            <p className="description text-center text-custom-rhino">
              Project details for this year are coming soon.
            </p>
          </div>
        </section>
        <Footer />
  ...
  const project = projectProp as AnyProjectForYearPage;
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {project?.design.keyComponents.map((component: { name: string; description: string }) => {
                    return (
                      <motion.div
                        variants={fadeIn}
                        key={component.name}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {project?.teamGoals.map((goal: { id: number; point: string }) => {
                    return (
                      <motion.div
                        variants={fadeIn}
                        key={goal.id}
              ...
              >
                ...
                >
                  ...
                  <ul className="list-disc pl-10">
                    {project?.competitionRequirements.bullets.map((point: { id: number; point: string }) => {
                      return (
                        <motion.li
                          variants={fadeIn}
                          key={point.id}
        ...
        {project?.design?.descentControl.show && (
          ...
          >
            ...
            >
              ...
              {project?.design?.descentControl?.items?.map((item: { name: string; bullets: string[]; image: string }, index: number) => {
                return (
                  <motion.div
                    key={index}
                    variants={fadeIn}
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-5 justify-between">
                {project?.design?.mechanicalSubsystem?.items.map(
                  (item: { name: string; bullets: string[] }, index: number) => {
                    return (
                      <motion.div
                        key={index}
                        variants={fadeIn}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {project?.design?.flightSoftware?.items.map(
...
export default ProjectYearContent;
