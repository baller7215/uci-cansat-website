...
type ProjectYearContentProps = {
  yearLabel?: string;
  project: any | null;
};

const ProjectYearContent = ({ yearLabel, project }: ProjectYearContentProps) => {
  if (!project) {
    return (
      <main>
        <CoverPage
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {(project?.design?.keyComponents || []).map(
                    (component: any) => {
                      return (
                        <motion.div
                          variants={fadeIn}
              ...
              >
                ...
                >
                  ...
                  <ul className="list-disc pl-10">
                    {(project?.design?.majorComponents?.bulletPoints ||
                      []
                    ).map((point: any) => {
                      return (
                        <motion.li
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {(project?.teamGoals || []).map((goal: any) => {
                    return (
                      <motion.div
                        variants={fadeIn}
                        key={goal.id}
              ...
              >
                ...
                >
                  ...
                  <ul className="list-disc pl-10">
                    {(project?.competitionRequirements?.bullets || []).map(
                      (point: any) => {
                        return (
                          <motion.li
                            variants={fadeIn}
        ...
        {project?.design?.descentControl?.show && (
          ...
          >
            ...
            >
              ...
              {(project?.design?.descentControl?.items || []).map(
            ...
            >
              ...
              >
                <ul className="my-auto">
                  {(project?.design?.electricalPowerSubsystem?.bullets ||
                    []
