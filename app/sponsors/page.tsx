            ...
            <main>
                ...
                >
                    <div className="text-container !flex-col !h-auto min-h-screen text-custom-white">
                        <motion.div className="flex flex-row justify-between w-full" variants={fadeIn}>
                    ...
                    <motion.div className="text-container md:!h-auto md:!min-h-screen !flex-col !justify-center" variants={fadeIn}>
                        ...
                        <div className="flex flex-col md:flex-row justify-between gap-20">
                            {whySponsorUs.reasons.map((reason) => (
                                <motion.div key={reason.title} className="w-full h-full flex flex-col gap-3" variants={fadeIn}>
                    ...
                    <motion.div className="text-container md:!h-auto md:!min-h-screen !h-fit !flex-col !gap-0 !py-20" variants={fadeIn}>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between gap-10 mt-5">
                            {sponsorshipTiers.map((tier, index) => (
                                <motion.div key={index} className="tier-card w-fit lg:w-1/3 mx-auto" variants={fadeIn}>
