...
import { projectsLinks, teamLinks } from "@/constants";
    ...
    <div className="z-20 navbar bg-gradient-to-b from-white/100 to-white/0 backdrop-saturate-150 backdrop-blur-[1px]">
      ...
      <nav className="navbar-nav">
        <ul className="navbar-nav-elements">
          <Link
            href="/about"
            className={`navbar-nav-element group ${
              pathname === "/about" ? "navLink-bold" : "navLink"
            }`}
          >
            About
          </Link>
          ...
          <div className="relative group">
            <Link
              href="/team"
              className={`navbar-nav-element group ${
                pathname === "/team" ? "navLink-bold" : "navLink"
              }`}
            >
              Team
            </Link>
          ...
          <div className="relative group">
            <Link
              href="/projects"
              className={`navbar-nav-element group ${
                pathname === "/projects" ? "navLink-bold" : "navLink"
              }`}
            >
              Projects
            </Link>
          ...
          <Link
            href="/sponsors"
            className={`navbar-nav-element group ${
              pathname === "/sponsors" ? "navLink-bold" : "navLink"
            }`}
          >
            Sponsors
          </Link>
          <Link
            href="/updates"
            className={`navbar-nav-element group ${
              pathname === "/updates" ? "navLink-bold" : "navLink"
            }`}
          >
            Updates
          </Link>
          <Link
            href="/contact"
            className={`navbar-nav-element group ${
              pathname === "/contact" ? "navLink-bold" : "navLink"
            }`}
          >
            Contact
          </Link>
      ...
      <Button
        asChild
        variant="outline"
        className="navbar-join-button hover:navbar-join-hover !bg-custom-rhino !text-custom-white hover:!bg-transparent hover:!text-custom-rhino border-2 !border-custom-rhino transition ease-in-out duration-500"
      >
